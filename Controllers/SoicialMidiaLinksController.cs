...
namespace Icity.Controllers
{
    ...
    public class SoicialMidiaLinksController : Controller
    {
        ...
        public SoicialMidiaLinksController(IcityContext context) {
            _context = context;
        }

        [HttpGet]
        public async Task<IActionResult> Get(DataSourceLoadOptions loadOptions) {
            var soicialmidialinks = _context.SoicialMidiaLinks.Select(i => new {
                i.id,
                i.facebooklink,
                i.WhatsApplink,
                i.LinkedInlink,
            ...
            return Json(await DataSourceLoader.LoadAsync(soicialmidialinks, loadOptions));
        }
        ...
        public async Task<IActionResult> Post(string values) {
            ...
            var result = _context.SoicialMidiaLinks.Add(model);
        ...
        public async Task<IActionResult> Put(int key, string values) {
            var model = await _context.SoicialMidiaLinks.FirstOrDefaultAsync(item => item.id == key);
            if(model == null)
        ...
        public async Task Delete(int key) {
            ...
            _context.SoicialMidiaLinks.Remove(model);
            await _context.SaveChangesAsync();
        }
        ...
        private void PopulateModel(SoicialMidiaLink model, IDictionary values) {
            ...
            string YOUTUBE_LINK = nameof(SoicialMidiaLink.YoutubeLink);
            ...
            if(values.Contains(YOUTUBE_LINK)) {
                model.YoutubeLink = Convert.ToString(values[YOUTUBE_LINK]);
            }
        }
