...
namespace Icity.Areas.TemplatePages.Pages
{
    public class UserProfileInfoModel : PageModel
    {
        ...
        public UserProfileInfoModel(ApplicationDbContext applicationDbContext, UserManager<ApplicationUser> userManager, SignInManager<ApplicationUser> signInManager, IcityContext Context)
        {
